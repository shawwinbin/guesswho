...
describe('extractGuessFromQuestion', () => {
  it('extracts only explicit final-answer guesses from question-like input', () => {
  ...
  it('does not treat normal named questions as final-answer submissions', () => {
    expect(extractGuessFromQuestion('他是李白吗？')).toBeNull()
